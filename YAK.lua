...
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
os.execute('screen -S YAK -X kill') 
os.execute('screen -S YAK ./YAK.sh') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="TagAll.lua ↬ "..CheckFile1.."",callback_data="/HelpList2:"..msg.sender_user_id_},{text="ProNames.lua ↬ "..CheckFile2.."",callback_data="/HelpList1:"..msg.sender_user_id_}},{{text="۾₃",callback_data="/HelpList4:"..msg.sender_user_id_},{text="⁃ اࢦـ؏ـاب .",callback_data="/HelpList3:"..msg.sender_user_id_}},{{text="⁃ اࢦتسليه .",callback_data="/HelpList6:"..msg.sender_user_id_},{text="⁃ اوامࢪ مطوࢪ .",callback_data="/HelpList5:"..msg.sender_user_id_}},{{text="اوامر الرتب",callback_data="/DelList:"..msg.sender_user_id_}},{{text="التفعيل و التعطيل",callback_data="/lockorder:"..msg.sender_user_id_},{text="القفل و الفتح",callback_data="/locklist:"..msg.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
