...
Text = "⌯︙تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm YAK ›",url="t.me/nnnnBn"}}}
