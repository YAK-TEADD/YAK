...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌗ : اضفني لڪࢪوبك .',url="t.me/"..dpbot.username_.."?startgroup=botstart"}},{{text=''..result.first_name_..'',url="https://t.me/nnnnBn"},{text = '⌗ : السوࢪس .',url="https://t.me/nnnnBn"}}}
