...
Dev_ALS(msg.chat_id_, msg.id_, 1, "⌯︙ه‍ـلا ڪࢦـبي  ← ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
...
EditMsg(Chat_Id2, Msg_Id2, "⌯︙ه‍ـلا ڪࢦـبي للاسف ماعدي صلاحيات حظࢪ المستخدمين فـعلها اول !") 
return false  
end
...
SendText(NewDev,"⌯︙ه‍ـلا ڪࢦـبي  ← ["..dp.first_name_.."](tg://user?id="..dp.id_..")\n⌯︙لقد اصبحت انت مطور هذا البوت",0,'md')
end,nil)
local Create = function(data, file, uglify)  
file = io.open(file, "w+")   
local serialized  
...
Text = "*⌯︙تم حـبيبي حذفت المنشئيـن الاساسين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_},{text="⁃ اࢦـقائمه الࢪئيسيه .",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
Text = "*⌯︙تم يبـ؏ـدي حذفـت اࢦـمميزين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_},{text="⁃ اࢦـقائمه الࢪئيسيه .",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
Text = "*⌯︙تم ڪـࢦـبي حذفـت اࢦـمنظفين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_},{text="⁃ اࢦـقائمه الࢪئيسيه .",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
Text = "*⌯︙تم ضلـعي مسحت ڪل المڪتومين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Text = "*⌯︙تم يبـ؏ـدي مسحت ڪل المقيدين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Text = "*⌯︙تم يڪلبي مسحت ڪل المحظوࢪين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
Text = "*⌯︙تم حبيبـي مسحت قائمه العام ڪلهم*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Text = "*⌯︙تم يـقࢦـبي حذفت ڪل ࢪدود المديࢪ*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
...
if #redod == 0 then
Text = "*⌯︙للاسـف ࢦاتوﺟد ࢪدود مضافه حاليا ! *"
else
for k,v in pairs(redod) do
...
Text = "*⌯︙تم يڪࢦـبي حذفت ڪل ࢪدود المطوࢪ*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Text = "⌯︙تم يڪࢦـبي حذفت ڪل الاوامࢪ المضافه للمجموعه "
keyboard = {} 
...
Text = "⌯︙ه‍ـلا قࢦـبي تم تفعيل البوت في المجموعه بنجاح . "..dp.title_
keyboard = {} 
...
Text = "⌯︙ه‍ـلا قࢦـبي تم تفعيل البوت في المجموعه بنجاح ."
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ ࢪفـ؏ اࢦادمنيه .",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="⁃ طࢪد البـوت .",callback_data="/LeaveBot:"..data.sender_user_id_},{text="⁃ تـ؏ـطيل البـوت .",callback_data="/Stop:"..data.sender_user_id_}},{{text="⁃ سـوࢪس و؏ـد .",url="t.me/nnnnBn"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     -- 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_},{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر الاعضاء",callback_data="/HelpList6:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="اوامر الادمنيه",callback_data="/HelpList2:"..data.sender_user_id_},{text="اوامر الحمايه",callback_data="/HelpList1:"..data.sender_user_id_}},{{text="اوامر المنشئين",callback_data="/HelpList4:"..data.sender_user_id_},{text="اوامر المدراء",callback_data="/HelpList3:"..data.sender_user_id_}},{{text="اوامر المطورين",callback_data="/HelpList5:"..data.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text="⁃ ࢪجو؏ .",callback_data="/HelpList:"..data.sender_user_id_}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⌯ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..msg.sender_user_id_},{text="ترتيب الاوامر",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
...
local inline = {
{{text="⌯ المطور .",url="t.me/"..(dp.username_ or "nnnnBn")}},
{{text="⌯ السورس .",url="https://t.me/nnnnBn"},{text="⌯ لتنصيب بوت .",url="https://t.me/VvTVv2"}},{{text="⌯ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
local Text = [[
*⌯︙ه‍ـلا يبـ؏ـدي اختاࢪ نوع الرابط ليتم اࢪساله اليك .*
]] 
keyboard = {} 
...
send(msg.chat_id_,msg.id_,"⌯︙ه‍ـلا ڪࢦـبي للاسف ماعدي صلاحيات حظࢪ المستخدمين فـعلها اول !") 
return false  
end
...
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.خchat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"⌯︙ه‍ـلا ڪࢦـبي للاسف ماعدي صلاحيات حظࢪ المستخدمين فـعلها اول !") 
return false  
end
...
ReplyStatus(msg,result.id_,"Reply","⌯︙تم ڪتمه من المجموعه")  
end
end
else 
Dev_ALS(msg.chat_id_, msg.id_, 1, '⌯︙*المعرف غير صحيح*', 1, 'md')
...
ReplyStatus(msg,user,"Reply","⌯︙تم ڪتمه من المجموعه")  
end
end
end
--     Source YAK     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="⁃ مسـح اࢦـمدࢪاء .",callback_data="/DelManager:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌯︙تم حذف المڪتومين")  
end
...
local Text ='*⌯︙تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/gif:"..msg.sender_user_id_}},{{text = '⌯ YAK Team .',url="t.me/nnnnBn"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌯︙تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/memz:"..msg.sender_user_id_}},{{text = '⌯ YAK Team .',url="t.me/nnnnBn"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '⌯ YAK Team .',url="t.me/nnnnBn"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/remix:"..msg.sender_user_id_}},{{text = '⌯ YAK Team .',url="t.me/nnnnBn"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⌯︙تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⌯",callback_data="/photo:"..msg.sender_user_id_}},{{text = '⌯ YAK Team .',url="t.me/nnnnBn"}}} 
local msg_id = msg.id_/2097152/0.5 
