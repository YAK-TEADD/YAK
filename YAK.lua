...
NumFile = NumFile + 1
TextS = TextS.."⌯︙"..Info..' ← ⤈\n'..NumFile.."~ : `"..name..'` ↬ '..CheckFile1.."\n"
end
keyboard = {} 
keyboard.inline_keyboard = {{{text="TagAll.lua ↬ ("..CheckFile1..")",callback_data="/HelpList2:"..msg.sender_user_id_},{text="۾₂",callback_data="/HelpList1:"..msg.sender_user_id_}},{{text="۾₃",callback_data="/HelpList4:"..msg.sender_user_id_},{text="⁃ اࢦـ؏ـاب .",callback_data="/HelpList3:"..msg.sender_user_id_}},{{text="⁃ اࢦتسليه .",callback_data="/HelpList6:"..msg.sender_user_id_},{text="⁃ اوامࢪ مطوࢪ .",callback_data="/HelpList5:"..msg.sender_user_id_}},{{text="اوامر الرتب",callback_data="/DelList:"..msg.sender_user_id_}},{{text="التفعيل و التعطيل",callback_data="/lockorder:"..msg.sender_user_id_},{text="القفل و الفتح",callback_data="/locklist:"..msg.sender_user_id_}},{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(TextS).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
else
