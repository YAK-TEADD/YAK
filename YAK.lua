...
local CheckFileisFound = io.open("Files/ProNames.lua","r")
if CheckFileisFound then
io.close(CheckFileisFound)
CheckFile2 = "(✔)"
else
...
local CheckFileisFound = io.open("Files/ChangeName.lua","r")
if CheckFileisFound then
io.close(CheckFileisFound)
CheckFile4 = "(✔)"
else
...
local CheckFileisFound = io.open("Files/ChangeUser.lua","r")
if CheckFileisFound then
io.close(CheckFileisFound)
CheckFile5 = "(✔)"
else
...
local CheckFileisFound = io.open("Files/AutoFile.lua","r")
if CheckFileisFound then
io.close(CheckFileisFound)
CheckFile6 = "(✔)"
else
...
local CheckFileisFound = io.open("Files/ChangePhoto.lua","r")
if CheckFileisFound then
io.close(CheckFileisFound)
CheckFile7 = "(✔)"
else
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="TagAll.lua ↬ ",callback_data="/HelpList2:"..msg.sender_user_id_},{text=CheckFile1,callback_data="/HelpList1:"..msg.sender_user_id_}},
{{text="ProNames.lua ↬ ",callback_data="/HelpList4:"..msg.sender_user_id_},{text=CheckFile2,callback_data="/HelpList3:"..msg.sender_user_id_}},
{{text="AddedMe.lua ↬ ",callback_data="/HelpList6:"..msg.sender_user_id_},{text=CheckFile3,callback_data="/HelpList5:"..msg.sender_user_id_}},
{{text="AddedMe.lua ↬ ",callback_data="/DelList:"..msg.sender_user_id_},{text=CheckFile4,callback_data="/HelpList5:"..msg.sender_user_id_}},
{{text="ChangeUser.lua ↬ ",callback_data="/DelList:"..msg.sender_user_id_},{text=CheckFile5,callback_data="/HelpList5:"..msg.sender_user_id_}},
{{text="AutoFile.lua ↬ ",callback_data="/DelList:"..msg.sender_user_id_},{text=CheckFile6,callback_data="/HelpList5:"..msg.sender_user_id_}},
{{text="ChangePhoto.lua ↬ ",callback_data="/DelList:"..msg.sender_user_id_},{text=CheckFile7,callback_data="/HelpList5:"..msg.sender_user_id_}},
