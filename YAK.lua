...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⌗ ⁃ قنـاۿ اࢦـسوࢪس .',url="https://t.me/nnnnBn"}},{{text = '⌗ ⁃ مـطوࢪ اࢦـسوࢪس .',url="t.me/VvTVv2"},{text = '⌗ ⁃ تـواصࢦ اࢦـسوࢪس .',url="https://t.me/nnnnBn"}},{{text = 'اخفاء',callback_data="/HideHelpList:"..msg.sender_user_id_"}}}
local msg_id = msg.id_/2097152/0.5
