...
{{text="TagAll.lua ↬ ",callback_data="/HelpList4:"..msg.sender_user_id_},{text=CheckFile2,callback_data="/HelpList3:"..msg.sender_user_id_}},
{{text="⁃ اࢦتسليه .",callback_data="/HelpList6:"..msg.sender_user_id_},{text="⁃ اوامࢪ مطوࢪ .",callback_data="/HelpList5:"..msg.sender_user_id_}},
{{text="اوامر الرتب",callback_data="/DelList:"..msg.sender_user_id_}},
{{text="التفعيل و التعطيل",callback_data="/lockorder:"..msg.sender_user_id_},{text="القفل و الفتح",callback_data="/locklist:"..msg.sender_user_id_}},
