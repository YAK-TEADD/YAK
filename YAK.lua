...
--     Source YAK     --
if DataText and DataText:match('/TagAll:') then
...
{{text="ProNames.lua ↬ ",callback_data="/HelpList4:"..data.sender_user_id_},{text=CheckFile2,callback_data="/HelpList3:"..data.sender_user_id_}},
{{text="AddedMe.lua ↬ ",callback_data="/HelpList6:"..data.sender_user_id_},{text=CheckFile3,callback_data="/HelpList5:"..data.sender_user_id_}},
{{text="ReplyBot.lua ↬ ",callback_data="/DelList:"..data.sender_user_id_},{text=CheckFile8,callback_data="/HelpList5:"..data.sender_user_id_}},
{{text="⁃ اخفاء اࢦـڪليشه .",callback_data="/HideHelpList:"..data.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=ايان فارغ'"&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
